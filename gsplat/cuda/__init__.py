...
rasterize_billboards_forward = _make_lazy_cuda_func("rasterize_billboards_forward")
rasterize_billboards_backward = _make_lazy_cuda_func("rasterize_billboards_backward")
...
project_gaussians_2d_uv_transform_forward = _make_lazy_cuda_func("project_gaussians_2d_uv_transform_forward")
project_gaussians_2d_uv_transform_backward = _make_lazy_cuda_func("project_gaussians_2d_uv_transform_backward")
